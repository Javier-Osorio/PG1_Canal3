<%@ Page Title="" Language="C#" MasterPageFile="~/SitioWeb.Master" AutoEventWireup="true" CodeBehind="WebNombrePelicula.aspx.cs" Inherits="WebApp.WebForms.Programacion.WebNombrePelicula" %>
        ...
        <div class="col-12">
            <div class="card">                
                ...
                <div class="card-body table-responsive p-0">
                    <asp:GridView ClientIDMode="Static" AutoGenerateColumns="false" DataKeyNames="ID_NOMBRE_PELICULA" ID="tabla_nombre_pelicula" runat="server" AllowPaging="true" CssClass="table table-hover text-nowrap"
                        OnPageIndexChanging="tabla_nombre_pelicula_PageIndexChanging" OnRowEditing="tabla_nombre_pelicula_RowEditing"
                        OnRowDeleting="tabla_nombre_pelicula_RowDeleting" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false">
                        <Columns>
                            <asp:BoundField HeaderText="Id_Nombre_Pelicula" DataField="ID_NOMBRE_PELICULA" ReadOnly="true" />
    ...
    <div class="modal fade" id="modalRegistrar" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <asp:Panel ID="pnlPeliculaRegister" runat="server" DefaultButton="btnRegistrar">
    ...
    <div class="modal fade" id="modalEditar" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <asp:Panel ID="pnlPeliculaEdit" runat="server" DefaultButton="btnActualizar">
                    <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input runat="server" id="codNombre" type="hidden"/>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
