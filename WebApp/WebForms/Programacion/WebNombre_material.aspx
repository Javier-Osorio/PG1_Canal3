<%@ Page Title="" Language="C#" MasterPageFile="~/SitioWeb.Master" AutoEventWireup="true" CodeBehind="WebNombre_material.aspx.cs" Inherits="WebApp.WebForms.Programacion.WebNombre_material" %>
        ...
        <div class="col-12">
            <div class="card">                
                ...
                <div class="card-header">
                    <h3 class="card-title">Nombre Material</h3>
                    <br /><br />
                ...
                <div class="card-body table-responsive p-0">
                    <asp:GridView ClientIDMode="Static" AutoGenerateColumns="false" DataKeyNames="ID_NOMBRE" ID="tabla_nombre_material" runat="server" AllowPaging="true" CssClass="table table-hover text-nowrap"
                        OnPageIndexChanging="tabla_nombre_material_PageIndexChanging" OnRowEditing="tabla_nombre_material_RowEditing"
                        OnRowDeleting="tabla_nombre_material_RowDeleting" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false">
                        <Columns>
                            <asp:BoundField HeaderText="Id_Nombre_Material" DataField="ID_NOMBRE" ReadOnly="true" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input runat="server" id="codMaterial" type="hidden"/>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
