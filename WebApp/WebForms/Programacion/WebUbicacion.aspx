...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script = "text/javascript" >
        ...
        function confirmarEliminar() {
            var respuesta = confirm("Deseas eliminar el No. de registro?");
            ...
            <div class="card">                
                ...
                <div class="card-body table-responsive p-0">
                    <asp:GridView ClientIDMode="Static" AutoGenerateColumns="false" DataKeyNames="ID_UBICACION" ID="tabla_ubicaciones" runat="server" AllowPaging="true" CssClass="table table-hover text-nowrap"
                        ...
                        OnRowDeleting="tabla_ubicaciones_RowDeleting" OnRowUpdating="tabla_ubicaciones_RowUpdating" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton runat="server" Text="Eliminar" CommandName="Delete" OnClientClick="return confirmarEliminar()"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
