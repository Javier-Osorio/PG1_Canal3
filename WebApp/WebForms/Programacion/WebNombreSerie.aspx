<%@ Page Title="" Language="C#" MasterPageFile="~/SitioWeb.Master" AutoEventWireup="true" CodeBehind="WebNombreSerie.aspx.cs" Inherits="WebApp.WebForms.Programacion.WebNombreSerie" %>
        ...
        <div class="col-12">
            <div class="card">                
                ...
                <div class="card-body table-responsive p-0">
                    <asp:GridView ClientIDMode="Static" AutoGenerateColumns="false" DataKeyNames="ID_NOMBRE_SERIE" ID="tabla_nombre_serie" runat="server" AllowPaging="true" CssClass="table table-hover text-nowrap"
                        OnPageIndexChanging="tabla_nombre_serie_PageIndexChanging" OnRowEditing="tabla_nombre_serie_RowEditing"
                        OnRowDeleting="tabla_nombre_serie_RowDeleting" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false">
                        <Columns>
                            <asp:BoundField HeaderText="Id_Nombre_Serie" DataField="ID_NOMBRE_SERIE" ReadOnly="true" />
    ...
    <div class="modal fade" id="modalRegistrar" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <asp:Panel ID="pnlSerieRegister" runat="server" DefaultButton="btnRegistrar">
    ...
    <div class="modal fade" id="modalEditar" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <asp:Panel ID="pnlSerieEdit" runat="server" DefaultButton="btnActualizar">
                    <div class="modal-header">
