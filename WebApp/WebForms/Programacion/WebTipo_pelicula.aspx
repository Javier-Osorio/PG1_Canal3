        ...
        <div class="col-12">
            <div class="card">                
                ...
                <div class="card-header">
                    <h3 class="card-title">Tipo de Pelicula</h3>
                    <br /><br />
                ...
                <div class="card-body table-responsive p-0">
                    <asp:GridView ClientIDMode="Static" AutoGenerateColumns="false" DataKeyNames="ID_TIPO_PELICULA" ID="tabla_tipo_pelicula" runat="server" AllowPaging="true" CssClass="table table-hover text-nowrap"
                        OnPageIndexChanging="tabla_tipo_pelicula_PageIndexChanging" OnRowEditing="tabla_tipo_pelicula_RowEditing"
                        OnRowDeleting="tabla_tipo_pelicula_RowDeleting" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false">
                        <Columns>
                            <asp:BoundField HeaderText="Id_Tipo_Pelicula" DataField="ID_TIPO_PELICULA" ReadOnly="true" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input runat="server" id="codPelicula" type="hidden"/>
                </div>
                <div class="modal-footer justify-content-between">
